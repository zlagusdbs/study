...
# Elasticsearch Cluster
하나 이상의 노드(서버)가 논리적으로 묶여 데이터를 저장하고 검색하는 최상위 시스템
...
## Node Settings
### roles
![Infra, ELK Stack, Elasticsearch Cluster.png](../Resource/Infra%2C%20ELK%20Stack%2C%20Elasticsearch%20Cluster.png)
...
#### remote_cluster_client(=coordinator)
중계, 라우팅, 합을 담당

#### ingest
data의 가공, 변환, 처리를 담당(data index 전에 작용)
